...
public class CustomerViewLocalCars implements ActionListener {
    ...
    public CustomerViewLocalCars(CustomerPage customerPage) {
        this.customerPage = customerPage;
        frame = new JFrame("Local Cars");
    ...
    private void refreshTable() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("cars.txt"))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if ((parts[4].equals("Perodua") || parts[4].equals("Proton")) && parts[6].equals("Available")) {
                    model.addRow(parts);
                }
            }
